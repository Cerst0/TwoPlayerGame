...
namespace Mirror
{
    ...
    public static class NetworkClient
    {
        ...
        internal static void ApplySpawnPayload(NetworkIdentity identity, SpawnMessage message)
        {
            ...
            {
                Debug.Log(identity.name + "set true");
        ...
        {
            //Debug.Log(identity.gameObject.activeSelf + "  Check if identity is valid  " +  identity.gameObject.hideFlags);
        ...
        public static void PrepareToSpawnSceneObjects()
        {
            ...
            foreach (NetworkIdentity identity in allIdentities)
            {
                ...
                if (ConsiderForSpawning(identity))
                {
                    ...
                    //Debug.Log(identity.name + identity.sceneId + " was added to spawnableObjects");
                }
            }
        }
